...
function setColorRandom(){
    ...
    /* change color pages */
    document.querySelector(".about").style.backgroundColor = theme.colorPrimary;
    document.querySelector(".porfolio").style.backgroundColor = theme.colorPrimary;

    document.querySelector(".intro").style.color = theme.colorAlternate;

    /*change color icons */
    const icons = document.querySelectorAll("i");
    for(var i = 0 ; i < icons.length ; i++){
        icons[i].style.color = theme.colorAlternate;
    }

    /* change snow */
    document.querySelector('.parallax').style.color = theme.colorHighlight;

    /* change tagline */
    document.querySelector(".tagline").style.color = theme.colorAlternate;

    /*project */
    var projects = document.querySelectorAll('.portfolio-item');
    for(var i = 0 ; i < projects.length ; i++){
        projects[i].style.backgroundColor = theme.colorAlternate;
        projects[i].style.color = theme.colorPrimary;
    }

    projects = document.querySelectorAll('.portfolio-item i');
    for(var i = 0 ; i < projects.length ; i++){
        projects[i].style.color = theme.colorPrimary;
    }
    

    document.querySelector(".portfolio-title").style.color = theme.colorAlternate
}
